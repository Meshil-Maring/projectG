  ...
  return (
    ...
    <section className="py-20 px-6 bg-white overflow-hidden">
      <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-center gap-8">
        ...
        >
          <p className="text-xs font-bold uppercase tracking-widest text-volunteer mb-3">
            Join Our Mission
          </p>
          <h2 className="text-3xl xl:text-4xl font-extrabold text-heading leading-tight mb-4">
          ...
          <motion.button
            ...
            className="inline-flex items-center gap-2 bg-volunteer text-white text-sm font-semibold px-6 py-3 rounded-full transition-colors duration-200 cursor-pointer"
          >
        ...
        <div className="flex flex-wrap justify-center gap-6 flex-1">
          {pillars.map(({ icon: Icon, label }, i) => (
            ...
            >
              <div className="w-16 h-16 rounded-full bg-volunteer-light flex items-center justify-center shadow-sm">
                <Icon size={26} className="text-volunteer" strokeWidth={1.8} />
              </div>
              <span className="text-xs font-semibold text-heading leading-tight whitespace-pre-line">
                {label}
              </span>
            </motion.div>
          ))}
